...
public class Horizon implements SensorEventListener {
	...
	public void startListening(Listener listener) {
		...
		if (mRotationSensor == null) {
			App.log("Rotation vector sensor not available; will not provide orientation bufData.");
			return;
		}
...
//		if (System.currentTimeMillis() - mTack > 555) {
//			mTack = System.currentTimeMillis();
//			App.log(String.format("orientation  %f,  %f", pitch, roll));
//		}
